  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "absolute md:relative w-full justify-end bg-white dark:bg-gray-800 left-0 top-0 z-10 mt-7 md:mt-0 px-4 md:px-0",
        ...
        [
          ...
          _vm.query || _vm.searching
            ? _c(
                ...
                {
                  staticClass:
                    "absolute top-0 right-0 leading-snug font-400 focus:outline-none pr-7 md:pr-3 text-3xl text-blue-500 hover:text-blue-600 ",
                  on: { click: _vm.reset }
                },
                [_vm._v("×")]
              )
                      ...
                      [
                        _vm._l(_vm.results, function(result, index) {
                          return _c(
                            "a",
                            {
                              key: result.link,
                              staticClass:
                                "bg-white dark:bg-gray-800 dark:text-white w-full dark:hover:bg-white dark:hover:text-gray-800 border-b border-blue-400 text-xl cursor-pointer p-4",
                              class: {
                        ...
                        !_vm.results.length
                          ? _c(
                              ...
                              {
                                staticClass:
                                  "bg-white dark:bg-gray-800 dark:text-white w-full dark:hover:bg-white dark:hover:text-gray-800 border-b border-blue-400 rounded-b-lg shadow cursor-pointer p-4"
                              },
                              [
