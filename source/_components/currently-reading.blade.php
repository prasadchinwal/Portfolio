<div class="grid grid-cols-1 sm:grid-cols-2 sm:px-8 sm:py-12 sm:gap-x-8 md:py-16 rounded-lg shadow-lg">
    ...
    <div class="col-start-1 row-start-2 px-4 sm:pb-16">
        <div class="flex items-center text-sm font-medium my-5 sm:mt-2 sm:mb-4">
            ...
            <div class="ml-1">
                <span class="text-black">{{ $currentRead->rating }}</span>
            </div>
    ...
    <div class="col-start-1 row-start-1 flex sm:col-start-2 sm:row-span-3">
        <div class="w-full grid grid-cols-3 grid-rows-2 gap-2">
            <div class="relative col-span-3 row-span-2 md:col-span-2">
                <img src="{{ $currentRead->cover }}" alt="{{ $currentRead->title }}" class="absolute inset-0 w-full h-full object-cover bg-gray-100 sm:rounded-lg" />
            </div>
        </div>
    </div>
</div>